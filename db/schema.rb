...
ActiveRecord::Schema.define(version: 20_160_324_191_217) do
  ...
  add_index 'resource_followers', %w(resource_id resource_type), name: 'index_resource_followers_on_resource_id_and_resource_type', using: :btree
  ...
  create_table 'save_data', force: :cascade do |t|
    ...
    t.datetime 'updated_at'
    t.integer  'user_id',            limit: 4
    t.integer  'stepmania_playtime', limit: 4
    t.integer  'nb_stream',          limit: 4
