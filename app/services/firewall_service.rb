...
class FirewallService
  URL = 'http://portforward.com/cports.htm'.freeze
  USUAL_PORTS = [80, 443].freeze
  STEAM_TCP_PORTS = 27_014..27_050
  STEAM_UDP_PORTS = [3478, 4379, 4380] + [27_000..27_030]
